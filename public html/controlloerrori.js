...
function controlloNome () {
  ...
  else if (nome.length < 3) {errore = 'Inserisci un nome, lungo almeno tre caratteri' ; sommaErrori = arrayErrori.push("errore"); }
...
function controlloCognome () {
  ...
  else if (cognome.length < 2) errore = 'Inserisci un cognome, lungo almeno due caratteri' ;
  var cognome = document.moduloForm.cognomeOpinione.value; var errore = "";
  if (cognome.length == 0) errore = 'Inserisci un cognome ' ;
  else if (cognome.length < 2) errore = 'Inserisci un cognome, lungo almeno due caratteri' ;
